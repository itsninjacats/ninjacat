...
>
	{#snippet children({ thumbItems })}
		<span
			...
			class={cn(
				"bg-muted rounded-4xl data-horizontal:h-3 data-horizontal:w-full data-vertical:h-full data-vertical:w-3 relative grow overflow-hidden data-horizontal:w-full data-vertical:h-full"
			)}
		>
